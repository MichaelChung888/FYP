...
import { view as view_5, update as update_1, init as init_1, Msg_$reflection as Msg_$reflection_1, Model_$reflection as Model_$reflection_1 } from "./pages/Login/Login.fs.js";
...
import { view as view_3, init as init_4, update as update_4, Msg_$reflection as Msg_$reflection_4, Model_$reflection as Model_$reflection_4 } from "./pages/Preferences/Preferences.fs.js";
import { view as view_4, init as init_5, update as update_5, Msg_$reflection as Msg_$reflection_5, Model_$reflection as Model_$reflection_5 } from "./pages/ProjectPropose/ProjectPropose.fs.js";
...
export class Url extends Union {
    ...
    cases() {
        return ["LoginUrl", "HomeStudentUrl", "ProjectsUrl", "PreferencesUrl", "ProjectProposeUrl", "NotFoundUrl", "EmptyUrl"];
    }
}
...
export class Page extends Union {
    ...
    cases() {
        return ["LoginPage", "HomeStudentPage", "ProjectsPage", "PreferencesPage", "ProjectProposePage", "NotFoundPage"];
    }
}

export function Page_$reflection() {
    return union_type("App.Page", [], Page, () => [[["Item", Model_$reflection_1()]], [["Item", Model_$reflection_2()]], [["Item", Model_$reflection_3()]], [["Item", Model_$reflection_4()]], [["Item", Model_$reflection_5()]], []]);
}
...
export class Msg extends Union {
    ...
    cases() {
        return ["LoginMsg", "HomeStudentMsg", "ProjectsMsg", "PreferencesMsg", "ProjectProposeMsg", "UrlChanged"];
    }
}

export function Msg_$reflection() {
    return union_type("App.Msg", [], Msg, () => [[["Item", Msg_$reflection_1()]], [["Item", Msg_$reflection_2()]], [["Item", Msg_$reflection_3()]], [["Item", Msg_$reflection_4()]], [["Item", Msg_$reflection_5()]], [["Item", Url_$reflection()]]]);
}
...
export function init() {
    ...
    const defaultModel = new Model(new ApplicationUser(0, []), initialUrl, new Page(5, []), "");
    switch (initialUrl.tag) {
        ...
        case 5:
            return [new Model(defaultModel.user, defaultModel.currentUrl, new Page(5, []), defaultModel.token), Cmd_none()];
        case 6:
...
export function update(msg, model) {
    ...
    let matchResult, msg_1, page_2, msg_3, page_3, msg_5, page_4, msg_7, page_5, msg_9, page_6, nextUrl;
    switch (msg.tag) {
        case 1: {
            if (matchValue.tag === 1) {
                matchResult = 1;
    ...
    switch (matchResult) {
        ...
        case 1:
            if (msg_3.tag === 2) {
                return [new Model(new ApplicationUser(0, []), model.currentUrl, model.currentPage, ""), Cmd_ofEffect((_arg_1) => {
        ...
        case 5:
            switch (nextUrl.tag) {
                case 1:
                    if (model.user.tag === 1) {
                        const patternInput_6 = init_2(model.token);
                        const newPage_6 = patternInput_6[0];
                        const newMsg_6 = patternInput_6[1];
                        return [showPage(new Page(1, [newPage_6]), new Url(1, [])), Cmd_map((arg_6) => (new Msg(1, [arg_6])), newMsg_6)];
                    }
                    else {
                        return [model, Cmd_ofEffect((_arg_5) => {
                            RouterModule_nav(singleton("login"), 2, 2);
                        })];
                    }
                case 2:
                    if (model.user.tag === 1) {
                        const patternInput_7 = init_3(model.token);
                        const newPage_7 = patternInput_7[0];
                        const newMsg_7 = patternInput_7[1];
                        return [showPage(new Page(2, [newPage_7]), new Url(2, [])), Cmd_map((arg_7) => (new Msg(2, [arg_7])), newMsg_7)];
                    }
                    else {
                        return [model, Cmd_ofEffect((_arg_6) => {
                            RouterModule_nav(singleton("login"), 2, 2);
                        })];
                    }
                case 3:
                    if (model.user.tag === 1) {
                        const patternInput_8 = init_4(model.token);
                        const newPage_8 = patternInput_8[0];
                        const newMsg_8 = patternInput_8[1];
                        return [showPage(new Page(3, [newPage_8]), new Url(2, [])), Cmd_map((arg_8) => (new Msg(3, [arg_8])), newMsg_8)];
                    }
                    else {
                        return [model, Cmd_ofEffect((_arg_7) => {
                            RouterModule_nav(singleton("login"), 2, 2);
                        })];
                    }
                case 4: {
                    ...
                    if (matchValue_5.tag === 1) {
                        ...
                        const patternInput_9 = init_5(model.token, user_5);
                        const newPage_9 = patternInput_9[0];
                        const newMsg_9 = patternInput_9[1];
                        return [showPage(new Page(4, [newPage_9]), new Url(2, [])), Cmd_map((arg_9) => (new Msg(4, [arg_9])), newMsg_9)];
                    }
                    else {
                ...
                case 5:
                    return [showPage(new Page(5, []), new Url(5, [])), Cmd_none()];
                case 6:
                    return [model, Cmd_ofEffect((_arg_9) => {
                        RouterModule_nav(singleton("login"), 2, 2);
                    })];
                default: {
                    const patternInput_5 = init_1();
                    const newPage_5 = patternInput_5[0];
                    const newMsg_5 = patternInput_5[1];
                    return [showPage(new Page(0, [newPage_5]), new Url(0, [])), Cmd_map((arg_5) => (new Msg(0, [arg_5])), newMsg_5)];
                }
            }
        default:
...
export function view(model, dispatch) {
    ...
    return RouterModule_router(createObj(ofArray([["hashMode", 2], ["onUrlChanged", (arg_2) => {
        dispatch(new Msg(5, [parseUrl(arg_2)]));
        ...
        switch (matchValue.tag) {
            ...
            default: {
                ...
                return singleton_1(view_5(page, (arg_4) => {
