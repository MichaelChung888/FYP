...
export function NavBar(dispatch, user) {
    ...
    return createElement("nav", createObj(Helpers_combineClasses("navbar", ofArray([["style", {
        ...
        return isStudent(user) ? append(singleton(createElement("div", createObj(Helpers_combineClasses("navbar-brand", ofArray([["onClick", (e) => {
            ...
            return singleton((elms_9 = ofArray([(elms_5 = toList(delay(() => append(singleton(createElement("a", createObj(Helpers_combineClasses("navbar-item", ofArray([["children", "Student Proposals"], ["onClick", (e_5) => {
                RouterModule_nav(ofArray(["home-supervisor", "projects"]), 1, 2);
            }]]))))), delay(() => append(singleton(createElement("a", createObj(Helpers_combineClasses("navbar-item", ofArray([["children", "Your Proposals"], ["onClick", (e_6) => {
                RouterModule_nav(ofArray(["home-supervisor", "proposals"]), 1, 2);
            }]]))))), delay(() => append(singleton(createElement("a", createObj(Helpers_combineClasses("navbar-item", ofArray([["children", "Propose a Project"], ["onClick", (e_7) => {
                RouterModule_nav(singleton_1("project-propose"), 1, 2);
            }]]))))), delay(() => ((user.categ === "C") ? append(singleton(createElement("a", createObj(Helpers_combineClasses("navbar-item", ofArray([["children", "All Projects"], ["onClick", (e_8) => {
                RouterModule_nav(ofArray(["home-supervisor", "all-projects"]), 1, 2);
            }]]))))), delay(() => singleton(createElement("a", createObj(Helpers_combineClasses("navbar-item", ofArray([["children", "All Preferences"], ["onClick", (e_9) => {
