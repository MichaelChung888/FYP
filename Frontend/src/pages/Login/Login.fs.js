...
import { AccountInfo_get_Decoder, LoginInfo_Encoder_Z5782A811, LoginInfo, AccountInfo_$reflection, LoginInfo_$reflection } from "../../../../Shared/Shared.fs.js";
...
export function Msg_$reflection() {
    return union_type("Login.Msg", [], Msg, () => [[["Item", string_type]], [["Item", string_type]], [["Item", class_type("Browser.Types.Event", void 0)]], [["Item", AccountInfo_$reflection()]], [["Item", class_type("System.Exception")]]]);
}
...
export function update(msg, model) {
    switch (msg.tag) {
        case 1: {
            ...
            return [new Model(new LoginInfo(model.login.Username, newPassword)), Cmd_none()];
        }
        case 2: {
            ...
            const handleSubmit = () => PromiseBuilder__Run_212F1D4B(promise, PromiseBuilder__Delay_62FBFDE1(promise, () => {
                ...
                const data = LoginInfo_Encoder_Z5782A811(model.login);
                return ((decoder = AccountInfo_get_Decoder(), PromiseBuilder__Run_212F1D4B_1(promise_1, PromiseBuilder__Delay_62FBFDE1_1(promise_1, () => {
                    ...
                    return ((data_3 = model.login, (caseStrategy_2 = void 0, (extra_2 = void 0, (() => {
                        let properties_4;
                        try {
        ...
        default: {
            ...
            return [new Model(new LoginInfo(newUsername, model.login.Password)), Cmd_none()];
        }
    }
}
