...
export function NavBar(dispatch) {
    ...
    }]])))), createElement("a", createObj(Helpers_combineClasses("navbar-item", ofArray([["children", "All Projects"], ["onClick", (e_4) => {
        RouterModule_nav(ofArray(["home-supervisor", "all-projects"]), 1, 2);
    }]])))), createElement("a", createObj(Helpers_combineClasses("navbar-item", ofArray([["children", "All Preferences"], ["onClick", (e_5) => {
...
//# sourceMappingURL=AllProjectsNavBar.fs.js.map
